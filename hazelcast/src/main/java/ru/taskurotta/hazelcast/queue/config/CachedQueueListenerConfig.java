 ...
 */
public class CachedQueueListenerConfig {
     ...
     */
    public CachedQueueListenerConfig() {
    }
     ...
     */
    public CachedQueueListenerConfig(String className) {
        setClassName(className);
    }

    public CachedQueueListenerConfig(CachedQueueListenerConfig config) {
     ...
     */
    public CachedQueueListenerConfig(EventListener implementation) {
     ...
     */
    public CachedQueueListenerConfig setImplementation(EventListener implementation) {
        this.implementation = isNotNull(implementation, "implementation");
        this.className = null;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        CachedQueueListenerConfig that = (CachedQueueListenerConfig) o;
