...
/**
 * <code>ActorRuntimeException</code> is the superclass of those
 * exceptions that can be thrown during operation of the
 * <code>ActorEngine</code>.
 *
 * User: romario
 * Date: 1/14/13
 * Time: 12:03 PM
...
public class ActorRuntimeException extends RuntimeException {
    ...
    static final long serialVersionUID = -7034897190745727401L;
