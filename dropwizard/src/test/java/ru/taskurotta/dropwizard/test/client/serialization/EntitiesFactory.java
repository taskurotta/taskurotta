...
public class EntitiesFactory {
    ...
    public static TaskContainer createTaskContainer() {
        ...
        return new TaskContainer(originalUuid, processUuid, originalMethod, originalActorId, originalTaskType,originalStartTime, originalNumberOfAttempts, new ArgContainer[]{originalArg1, originalArg2}, originalOptions, null);
    }
    ...
    public static DecisionContainer createDecisionContainer(boolean isError) {
        ...
        if (isError) {
            return new DecisionContainer(taskId, processId, null, createErrorContainer(), System.currentTimeMillis()+9000l, tasks, null, 0l);
        } else {
            return new DecisionContainer(taskId, processId, createArgSimpleValue(taskId), null, TaskDecision.NO_RESTART, tasks, null, 0l);
        }
