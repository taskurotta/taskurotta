...
lessc themes/multi_html/assets/css/print.less > target/html/assets/css/print.css
lessc themes/multi_html/assets/css/docs.less > target/html/assets/css/docs.css
lessc themes/multi_html/assets/css/reset.less > target/html/assets/css/reset.css
}
...
printf "Distributed process environment - Taskurotta | Documentation: version $version \n\n" >> $COPYRIGHT_FILE_NAME
printf "Publication date $date \n\n" >> $COPYRIGHT_FILE_NAME
printf "Copyright © $year Taskurotta.\n\n\n" >> $COPYRIGHT_FILE_NAME
...
echo "%Taskurotta Documentation" >> title.txt
echo "%version "$version >> title.txt
echo "%"$date >> title.txt

echo "Creating PDF Documentation"

#createPDF=$( pandoc title.txt $MERGED_FILE_NAME -o $PDF_FILE_NAME --toc --toc-depth=3 --chapters --number-sections
# --tab-stop=2 -V papersize:"a4paper" -H themes/margin.sty  --include-before-body=$COPYRIGHT_FILE_NAME )
...
# fix bug at bdoc 1.0.3 (affected from less)
lessc themes/single_html/assets/css/print.less > target/html-single/assets/css/print.css
lessc themes/single_html/assets/css/docs.less > target/html-single/assets/css/docs.css
lessc themes/single_html/assets/css/reset.less > target/html-single/assets/css/reset.css
}
...
function init {
	...
	PDF_OUTPUT_DIR="pdf"
	PDF_FILE_NAME="taskurotta-documentation-$version.pdf"
	MANIFEST_FILE_NAME="manifest.json"
	MERGED_FILE_NAME="taskurotta-documentation.md"
