...
public class ArgContainerDbObject extends CustomDBObject<ArgContainer> {
    ...
    public static ArgContainerDbObject[] toArray(ArgContainer[] args) {
        ArgContainerDbObject[] dbObjects = new ArgContainerDbObject[args.length];
        for (int i = 0; i < args.length; i++) {
            ...
            dbObjects[i] = argContainerDbObject;
        }
        return dbObjects;
    }
