...
public final class SerializationServiceImpl implements SerializationService {
    ...
    public SerializerAdapter serializerFor(final Class type) {
        ...
        if (serializersCache.putIfAbsent(type, serializer) == null) {
            String serializeName = serializer.getImpl().getClass().getName();
            // TODO: need for logger
//            System.err.println("====================== Cached new serializer [" + serializeName + "] for type [" +
//                    type +"]");
        }
