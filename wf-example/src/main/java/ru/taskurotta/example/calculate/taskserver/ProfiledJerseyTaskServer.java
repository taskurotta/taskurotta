...
import ru.taskurotta.client.jersey.JerseyTaskServerProxy;
...
public class ProfiledJerseyTaskServer extends JerseyTaskServerProxy {
	protected TaskLogger taskLogger;
	
	public ProfiledJerseyTaskServer(long loggingPeriod) {
		super();
