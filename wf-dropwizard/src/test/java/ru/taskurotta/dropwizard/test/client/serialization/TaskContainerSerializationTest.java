...
public class TaskContainerSerializationTest {
	...
	private TaskContainer createTaskContainer() {
		...
		return new TaskContainer(originalUuid, originalMethod, originalActorId, originalTaskType,originalStartTime, originalNumberOfAttempts, new ArgContainer[]{originalArg1, originalArg2}, originalOptions);
	}
