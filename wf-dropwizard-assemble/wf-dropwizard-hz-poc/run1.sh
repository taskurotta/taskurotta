java -Dts.hz.port=5701 -Xmx512m -Ddw.http.port=8811  -javaagent:./target/dependency/aspectjweaver-1.7.2.jar -jar target/wf-dropwizard-hz-poc-0.2.0-SNAPSHOT.jar server src/main/resources/conf.yml
